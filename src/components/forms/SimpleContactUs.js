...
const FormContainer = styled.div`
  ${tw`p-10 sm:p-12 md:p-16 bg-teal-500 text-gray-900 rounded-lg relative`}
  form {
    ${tw`mt-4`}
  }
  h2 {
      ...
      <Content>
        <FormContainer>
          <div tw="mx-auto max-w-4xl">
            <h2>Order Your Parts or Custom PC</h2>
            <form action="#">
              <TwoColumn>
                <Column>
                  <InputContainer>
                ...
                <Column>
                  <InputContainer tw="flex-1">
                    <Label htmlFor="name-input">Describe your needs</Label>
                    <TextArea id="message-input" name="message" placeholder="E.g. Details about your needs"/>
                  </InputContainer>
                </Column>
              </TwoColumn>
